...
echo  [96m    ██║  ██║██║     ██║  ██╗    ██║     ██║  ██║╚██████╔╝[0m
echo  [96m    ╚═╝  ╚═╝╚═╝     ╚═╝  ╚═╝    ╚═╝     ╚═╝  ╚═╝ ╚═════╝ [0m
echo  [93m              Multi Account AFK System[0m
echo  [90m                 created by @dkhanh[0m
echo  [92m═══════════════════════════════════════════════════════[0m
echo.

echo  [93m[1/4][0m Dang kiem tra moi truong...
timeout /t 1 >nul
...
if %errorlevel% neq 0 (
    ...
    echo  [93mHay tai tai: https://nodejs.org[0m
    echo.
    pause
    exit /b
)

echo  [92m[OK][0m Da co Node.js
echo.

echo  [93m[2/4][0m Dang tai kingbot.js...
...
echo  [92m[OK][0m Tai kingbot.js thanh cong

echo  [93m[3/4][0m Dang tai app.json...
...
echo  [92m[OK][0m Tai app.json thanh cong
echo.

echo  [93m[4/4][0m Dang cai dat module mineflayer...
...
echo  [92m[OK][0m Cai dat module thanh cong
echo.

echo  [92m═══════════════════════════════════════════════════════[0m
echo  [92m          CAI DAT HOAN TAT THANH CONG![0m
echo  [92m═══════════════════════════════════════════════════════[0m
echo.
echo  [96mDe chay bot, hay nhap lenh:[0m
echo.
echo      [93mnode kingbot.js[0m
echo.
